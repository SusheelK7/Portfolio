      ...
      <div className="max-w-5xl mx-auto px-6 py-28 w-full">
        ...
        <div className="reveal reveal-delay-1 bg-neutral-50 dark:bg-neutral-900 rounded-2xl border border-neutral-100 dark:border-neutral-800 p-8 md:p-10 mb-8">
          <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
            <div>
              <p className="font-mono text-xs tracking-widest uppercase text-neutral-400 dark:text-neutral-500 mb-2">
                Degree
              </p>
              ...
              <p className="font-body font-light text-sm text-neutral-400 dark:text-neutral-600 mt-1">
                Islamabad, Pakistan
              </p>
            </div>
            <div className="text-right shrink-0">
              <span className="inline-block px-4 py-2 rounded-full border border-neutral-200 dark:border-neutral-700 font-mono text-xs text-neutral-500 dark:text-neutral-400">
                2023 – 2027
              </span>
              <p className="font-mono text-xs text-neutral-300 dark:text-neutral-700 mt-2">
                In Progress
              </p>
            </div>
          </div>
        ...
        <div className="reveal reveal-delay-2">
          <p className="font-mono text-xs tracking-[0.2em] uppercase text-neutral-400 dark:text-neutral-500 mb-5">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              >
                ...
                <p className="font-body font-light text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">
                  {desc}
                </p>
              </div>
            ))}
